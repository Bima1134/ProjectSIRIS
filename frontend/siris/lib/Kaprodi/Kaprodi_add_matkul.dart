...
// Initialize logger
final loggerRuang = Logger('MyAddMatkulBatchPage');
...
void main() {
  ...
  runApp(AddMatkulBatch());
}

class AddMatkulBatch extends StatelessWidget {
  @override
...
class MyAddMatkulBatchPage extends StatefulWidget {
  final VoidCallback onCsvUploaded; // Callback to notify CSV upload success

  MyAddMatkulBatchPage({required this.onCsvUploaded});
  @override
  _MyAddMatkulBatchPageState createState() => _MyAddMatkulBatchPageState();
}

class _MyAddMatkulBatchPageState extends State<MyAddMatkulBatchPage> {
